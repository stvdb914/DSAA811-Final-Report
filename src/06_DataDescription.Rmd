...
contains `r dim(athletes)[1]` observations of `r dim(athletes)[2]` variables, "country_definitions.csv"
contains `r dim(countryDef)[1]` observations of `r dim(countryDef)[2]` variables,
"country_definitions_data_dictionary.csv" contains `r dim(countryDefdd)[1]`  observations of `r dim(countryDefdd)[2]`
variables, and "athlete_events.csv" containing `r prettyNum(dim(events)[1], big.mark=",", scientific = FALSE)` observations of
`r dim(events)[2]` variables.
