...
```{r functionGoldtable, include = TRUE, warnings = FALSE, echo = FALSE}
MedalWinners <- function(strSeason, nYear, inPos) {
 events %>% 
  ...
  #           caption = "Medals won",
  #           label = "Winners") %>%  
  #  kable_styling(latex_options = "striped", position = inPos)
}
```